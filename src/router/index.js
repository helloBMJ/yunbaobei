    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/navMain/mainComponents/setup_build"
            ], resolve),
          meta: { title: "编辑楼盘" },
          name: "编辑楼盘"
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/navMain/mainComponents/setup_type"
            ], resolve),
          meta: { title: "编辑户型" },
          name: "编辑户型"
          // children: [
...

        {
          ...
          component: resolve =>
            require([
              "@/components/navMain/mainComponents/updata_type"
            ], resolve),
          meta: { title: "户型添加" },
          name: "户型添加"
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/navMain/mainComponents/plan_photo"
            ], resolve),
          meta: { title: "规划图相册管理" },
          name: "规划图相册管理"
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/navMain/mainComponents/setup_photo"
            ], resolve),
          meta: { title: "编辑相册" },
          name: "编辑相册"
        },
        ...
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/navMain/projectInfo/commission_rules"
            ], resolve),
          meta: { title: "佣金规则" },
          name: "佣金规则"
        },
        {
          ...
          component: resolve =>
            require([
              "@/components/navMain/projectInfo/tel_information"
            ], resolve),
          meta: { title: "电话咨询" },
          name: "电话咨询"
        },
